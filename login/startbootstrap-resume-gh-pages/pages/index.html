...
<html lang="en">
  ...
  <body id="page-top" style="background-color:#EFF4FA">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="img/logo.png" alt="" onclick="openAlarm()">
        </span>
      </a>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="my-auto">
            ...
            <div class="resume-item d-flex flex-column flex-md-row mb-5">
				...
				<div id="myDIV" class="header">
					...
					<a href="profile.php?user=<?php echo $_GET['user'];?>">
					<span class="addBtn" style="background-color:#3385ff; color:white">Check profile</span>
					</a>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="Alarm">
        <div class="my-auto">
			 ...
			 <center><h3> Receiving alarm from <font color="E86E1F" id="displayedname">Marguerite Fleury</font> </h3></center>
			 ...
			 <h2 class="mb-5" style="color:CC3636"> CHANGE SETTINGS</h2>
				...
				<br><br>
				<center><button type="button" class="btn btn-success" onclick="changeit()">SET ALARM</button></center><br>
				<b><p id="myalert"  style="color:red; visibility:hidden">Error message here</p></b></center>
				
				<center>
                <button type="button" class="btn btn-failure" style="background-color:#DE3C31; color:white">ALARM OFF</button>
            </center>
...
list.addEventListener('click', function(ev) {
  if (ev.target.tagName === 'LI') {
    //ev.target.classList.toggle('checked');
	 ...
	 document.getElementById("myInput").innerHTML = "LOOOL"
...
function changeit() {
	  ...
	  if (usertime == ""){
		  var errormsg = document.getElementById("myalert");
		  errormsg.style.visibility = "visible" ;
		  errormsg.innerHTML = "Missing alarm time";
	  }
	  else{
		  if (friendname != "" && friendarr.indexOf(friendname) != -1){
			...
			document.getElementById("displayedtime").innerHTML = usertime;
			  	...
			  	var errormsg = document.getElementById("myalert");
				errormsg.style.visibility = "visible" ;
				errormsg.innerHTML = "Friend does not exist";
		  }
	  }
}
